"""
ADM1 Simulation model
"""
import numpy as np
from qsdsan import sanunits as su, processes as pc, WasteStream, System
from chemicals.elements import molecular_weight as get_mw

# Define molecular weights here for use throughout the module
C_mw = get_mw({'C': 1})
N_mw = get_mw({'N': 1})

# We initialize thermo in the package's __init__.py now
# to ensure it's set up when the package is imported

import sys
import os

# Add the parent directory to sys.path to access calculate_ph_and_alkalinity.py
